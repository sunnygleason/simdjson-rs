...
fn push_last_byte_of_a_to_b(a: __m256i, b: __m256i) -> __m256i {
    unsafe {
        _mm256_alignr_epi8(b, _mm256_permute2x128_si256(a, b, 0x21), 16 - 1)
    }
}
...
fn push_last_2bytes_of_a_to_b(a: __m256i, b: __m256i) -> __m256i {
    unsafe {
        _mm256_alignr_epi8(b, _mm256_permute2x128_si256(a, b, 0x21), 16 - 2)
    }
}
...
fn check_first_continuation_max(
    ...
    unsafe {
        ...
        *has_error = _mm256_or_si256(
            *has_error,
            _mm256_or_si256(badfollow_ed, badfollow_f4),
        );
    }
}
